...
int main(int argc, char *argv[])
{
    ...
    typedef nvl::RangeTree2D RangeTree2D;


    //Note that there is also a range tree for 3D points: nvl::RangeTree3D
    ...
    typedef nvl::RangeTree<Point2d*, std::string*> RangeTreeWithPointers;
