 ...
 *
 * @param dimension Dimension of the range tree
 * @param customComparators Vector of comparators for each
 ...
 * @param start Starting value of the range
 * @param end End value of the range
 * @param out Container containing the nodes which have keys enclosed
 * in the input range
 */
template <class K, class T, class C>
 ...
 *
 * @param node Node for which the new node will be inserted into
 ...
 * climbing on parents (the input node is included)
 *
 * @param node Node from which the climbing starts
 * @param key Key of new node
 * @param value Value of new node
 * @param dim Dimension of the range tree
 */
template <class K, class T, class C>
 ...
 *
 * @param node Node for which the node will be erase from its
