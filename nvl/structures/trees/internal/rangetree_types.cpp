 ...
 * (X component)
 */
NVL_INLINE bool point2DDimensionComparatorX(const Point2d& o1, const Point2d& o2)
{
    if (o1.x() < o2.x())
        return true;
    if (o2.x() < o1.x())
 ...
 * (Y component)
 */
NVL_INLINE bool point2DDimensionComparatorY(const Point2d& o1, const Point2d& o2)
{
    if (o1.y() < o2.y())
        return true;
    if (o2.y() < o1.y())
 ...
 * (X component)
 */
NVL_INLINE bool point3DDimensionComparatorX(const Point3d& o1, const Point3d& o2)
{
    if (o1.x() < o2.x())
        return true;
    if (o2.x() < o1.x())
 ...
 * (Y component)
 */
NVL_INLINE bool point3DDimensionComparatorY(const Point3d& o1, const Point3d& o2)
{
    if (o1.y() < o2.y())
        return true;
    if (o2.y() < o1.y())
 ...
 * (Z component)
 */
NVL_INLINE bool point3DDimensionComparatorZ(const Point3d& o1, const Point3d& o2)
{
    if (o1.z() < o2.z())
        return true;
    if (o2.z() < o1.z())
 ...
 */
NVL_INLINE std::vector<DefaultComparatorType<Point2d>> getComparatorsForPoint2D()
{
 ...
 * @return Vector of comparators
 */
NVL_INLINE std::vector<DefaultComparatorType<Point3d>> getComparatorsForPoint3D()
{
    //Creating vector of comparators for each dimension
