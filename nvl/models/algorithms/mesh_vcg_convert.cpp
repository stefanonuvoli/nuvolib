...
/**
 * @brief Convert mesh to VCG mesh
 * @param mesh Mesh
...
/**
 * @brief Convert VCG mesh to mesh
 * @param mesh Mesh
 * @param vcgMesh VCG mesh
 * @param selectedOnly Include only selected elements
 * @param dim Dimension of the points
 */
template<class Mesh, class VCGMesh>
...
/**
 * @brief Convert VCG mesh to Eigen mesh
 * @param vcgMesh VCG mesh
 ...
 * @param birthFace Birth face of the resulting mesh
 * @param selectedOnly Include only selected elements
 * @param numVerticesPerFace Number of vertices per face
 * @param dim Dimension of the points
 */
...
/**
 * @brief Convert Eigen mesh to VCG mesh
 * @param V Eigen vertices
 * @param F Eigen faces
 * @param vcgMesh Resulting VCG mesh
 */
template<class VCGMesh>
...
/**
 * @brief Convert segments to a VCG edge mesh
